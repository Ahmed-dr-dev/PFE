    ...
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <div className="flex-1 flex items-center justify-center px-5 py-12">
        <div className="w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-sm p-8 sm:p-10">
          <p className="text-sm font-semibold tracking-widest text-emerald-600 uppercase mb-2">Mot de passe oublié</p>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Réinitialisation</h1>
          <p className="text-gray-600 text-sm mb-4">
            Saisissez le même identifiant que sur la page de connexion. Si un compte existe, vous recevrez un e-mail avec un
            lien sécurisé (Brevo).
          </p>
          <p className="text-amber-950/90 text-xs bg-amber-50 border border-amber-200 rounded-lg px-3 py-2 mb-8">
            Connexion avec un <strong>CIN</strong> ? Le lien est envoyé à l’<strong>e-mail de récupération</strong> défini dans
            votre profil (ou par l’administration), pas au CIN.
          </p>
          <ForgotPasswordForm />
        </div>
      </div>
