export default function CalendarPage() {
  const events = [
    {
      id: '1',
      title: 'Réunion de suivi avec Prof. Benali',
      date: '2024-03-15',
      time: '14:00 - 15:30',
      type: 'meeting',
      location: 'Bureau 205',
    ...
    {
      id: '2',
      title: 'Délai de soumission - Rapport intermédiaire',
      date: '2024-03-20',
      time: '23:59',
      type: 'deadline',
    },
    ...
    <div className="space-y-8">
      <div>
        <h1 className="text-4xl sm:text-5xl font-bold text-white mb-2">
          Calendrier <span className="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">PFE</span>
        </h1>
        <p className="text-gray-400 text-lg">Suivez vos rendez-vous et échéances importantes</p>
      </div>
            ...
            <div className="space-y-4">
              {events.map((event) => {
                ...
                const typeColors = {
                  ...
                  deadline: 'from-red-500/20 to-orange-500/20 border-red-500/30 text-red-300',
                ...
                return (
                  <div
                    key={event.id}
                    className={`p-6 bg-slate-700/30 border rounded-xl transition-all duration-200 ${
                      isPast
                        ? 'border-slate-600/50 opacity-60'
                        : `border-${event.type === 'meeting' ? 'blue' : event.type === 'deadline' ? 'red' : event.type === 'presentation' ? 'purple' : 'emerald'}-500/50 hover:scale-[1.02]`
                    }`}
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-2">
                          ...
                          <span
                            className={`px-3 py-1 rounded-lg text-xs font-semibold bg-gradient-to-r ${typeColors[event.type as keyof typeof typeColors]}`}
                          >
        ...
        <div className="space-y-6">
          ...
          <div className="relative bg-gradient-to-br from-slate-800/90 to-slate-900/90 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-6 shadow-xl">
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-slate-700/30 border border-slate-600/50 rounded-xl">
                <p className="text-gray-400 text-sm mb-1">Échéances à venir</p>
