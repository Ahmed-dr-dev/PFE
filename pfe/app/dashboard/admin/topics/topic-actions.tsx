  ...
  return (
    <div className="flex items-center gap-3 pt-4 border-t border-slate-700/50">
      <button
        ...
        disabled={loading}
        className="px-4 py-2 bg-gradient-to-r from-emerald-600 to-cyan-600 text-white rounded-lg hover:from-emerald-700 hover:to-cyan-700 transition-all duration-200 font-semibold text-sm shadow-lg hover:shadow-xl hover:shadow-emerald-500/25 disabled:opacity-50"
      >
        Approuver
      </button>
      <button
