      ...
      <div className="bg-white border border-gray-200 rounded-2xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input name="fullName" type="text" defaultValue={fullName} className="w-full px-4 py-2 bg-gray-100 border border-gray-200 rounded-lg text-gray-900 focus:outline-none focus:border-emerald-200" required />
          </div>
          <div>
          ...
          <div>
            ...
            <input name="phone" type="tel" defaultValue={user.phone || ''} className="w-full px-4 py-2 bg-gray-100 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:border-emerald-200" />
          </div>
          {role === 'student' && (
            <div>
              <label className="block text-sm font-semibold text-gray-600 mb-1">Année</label>
              <select name="year" defaultValue={user.year || ''} className="w-full px-4 py-2 bg-gray-100 border border-gray-200 rounded-lg text-gray-900 focus:outline-none focus:border-emerald-200">
          ...
          {role === 'professor' && (
            <>
              <div>
                ...
                <select name="department" defaultValue={user.department || ''} className="w-full px-4 py-2 bg-gray-100 border border-gray-200 rounded-lg text-gray-900 focus:outline-none focus:border-emerald-200">
              ...
              <div>
                ...
                <input name="office" type="text" defaultValue={user.office || ''} className="w-full px-4 py-2 bg-gray-100 border border-gray-200 rounded-lg text-gray-900 focus:outline-none focus:border-emerald-200" />
              </div>
              <div>
                <label className="block text-sm font-semibold text-gray-600 mb-1">Heures de bureau</label>
                <input name="officeHours" type="text" defaultValue={user.office_hours || ''} className="w-full px-4 py-2 bg-gray-100 border border-gray-200 rounded-lg text-gray-900 focus:outline-none focus:border-emerald-200" />
              </div>
              <div>
                <label className="block text-sm font-semibold text-gray-600 mb-1">Biographie</label>
                <textarea name="bio" rows={2} defaultValue={user.bio || ''} className="w-full px-4 py-2 bg-gray-100 border border-gray-200 rounded-lg text-gray-900 focus:outline-none focus:border-emerald-200 resize-none" />
              </div>
              <div>
                <label className="block text-sm font-semibold text-gray-600 mb-1">Expertise (virgules)</label>
                <input name="expertise" type="text" defaultValue={expertiseStr} className="w-full px-4 py-2 bg-gray-100 border border-gray-200 rounded-lg text-gray-900 focus:outline-none focus:border-emerald-200" />
              </div>
            </>
          )}
          {role === 'student' && (
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-600 mb-1">Nouveau mot de passe (optionnel)</label>
            <input name="password" type="text" minLength={6} placeholder="Laisser vide pour ne pas changer" className="w-full px-4 py-2 bg-gray-100 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:border-emerald-200" />
          </div>
